...
TOKEN = "6759750881:AAGtOLBUDcd8NPWYrEuu63VFpkDOaqKQbck"
...
def start(message):
    ...
    a = bot.get_chat_member('5984401505', message.from_user.id)
    allowed_list = ['member', 'administrator', 'creator', 'left']

    user_id = message.from_user.id
    if message.from_user.username:
        name = '@IT_Creative' + message.chat.username
    else:
        name = "noname"
    if True:
        ...
        bot.send_message(message.chat.id,
                         ...
                         "\n --@MBin_Dev_0071-- ga yozishingizni \nso'rab qolamiz 😊"
                         "\n_________________________________________"
                         "\nDO'STALRINGIZ BILAN ULASHING "
                         "\n<b>Dasturchi </b>: <i>@MBin_Dev_0071</i>"
